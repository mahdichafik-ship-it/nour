      ...
      {!isNative && (
        <section className="mac-download-banner" aria-label="Download Nour for Mac">
          <div className="mac-download-copy">
            <strong>Get Nour for Mac <span>v0.1.7</span></strong>
            <p>Automatic update checks with a native install window.</p>
          </div>
          <div className="mac-download-links">
            <a href="https://github.com/mahdichafik-ship-it/nour/releases/download/v0.1.7/Nour-0.1.7-arm64.dmg">Apple Silicon</a>
            <a href="https://github.com/mahdichafik-ship-it/nour/releases/download/v0.1.7/Nour-0.1.7-x64.dmg">Intel Mac</a>
          </div>
        </section>
      )}
